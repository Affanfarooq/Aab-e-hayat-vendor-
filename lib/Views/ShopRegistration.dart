...
//                       child: buildCustomProgressIndicator(),
//                     )),
//                 Expanded(
//                   child: PageView(
...
//   Widget buildStep(String heading, String description, Widget content) {
//     return Column(
...
//   Widget buildBasicInformationForm() {
//     return Center(
//       child: ListView(
...
//   Widget buildContactInformationForm() {
//     return Center(
//       child: ListView(
//         padding: EdgeInsets.symmetric(horizontal: 15),
//         shrinkWrap: true,
...
//             height: 10,
//           ),
//           buildImagePicker("Select Shop Image", shopController.pickShopImage,
//               shopController.shopImage),
//           buildImagePicker("Select CNIC Front Image",
//               shopController.pickCnicFrontImage, shopController.cnicFrontImage),
//           buildImagePicker("Select CNIC Back Image",
